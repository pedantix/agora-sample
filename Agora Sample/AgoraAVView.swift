...
/// These following are variables that are generated by the Agora control panel, every day of development they need to be changed, normally this would be handled by internal server handling of this. But that is outside of the scope of this project.
private let testingToken = "006eb430feee2b14c02996f78eca25fcd46IADUDc1fqAr/+5QvyQQthoqlghQTJa6e7PFtAIZmqOe3LZpjTicAAAAAEAAAIFGKf+eDYQEAAQB/54Nh"
